        ...
        <Box display="flex" backgroundColor="black">
            <Stack alignItems="baseline" m="5">
                ...
                <Text color="white" fontWeight={200} fontSize="s">
                    rlld is a tool André created when he didn't want to study for an exam.
                </Text>
                ...
                <Text color="white" fontWeight={200} fontSize="s">
                    It goes without saying that his mission is not a noble one...
                </Text>
                <Spacer />
                <Spacer />
                ...
                <Text color="white" fontWeight={200} fontSize="s">
                    To do this we take use of 9GAG shuffle to generate the random meme, with some probability. Beware this probability is your choice.
                </Text>
                <Text color="white" fontWeight={100} fontSize="xs">
                    We have no control over the content displayed on the meme and thus are not responsible for any effects it may have on the viewer.
                </Text>
            </Stack>
        </Box>
    );
